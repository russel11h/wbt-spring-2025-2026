...
<title>Admin Dashboard &mdash; Blood Donation Management</title>
...
<main class="main-content">
    <div class="page-header">
        <div>
            <h1 class="page-title">Manage Donor Staff</h1>
            <p class="page-sub">Register, edit, search and remove donor staff accounts</p>
        </div>
    </div>
    ...
    <?php if (isset($_GET['msg'])): ?>
        <?php 
            $messages = [
                'added' => 'Donor staff added successfully.',
                'updated' => 'Donor staff updated successfully.',
                'deleted' => 'Donor staff deleted successfully.'
            ];
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit Donor Staff (#' . intval($editing['id']) . ')' : '+ Add New Donor Staff' ?>
        </h3>
        ...
        <div class="card-toolbar">
            <div class="search-wrap">
                ...
                <input type="text" id="searchInput" class="search-input"
                       placeholder="Search by staff name, username or contact...">
            </div>
            ...
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    <?php if (empty($librarians)): ?>
                        <tr>
                            <td colspan="5" class="empty">No donor staff yet.</td>
                        </tr>
                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn-sm btn-delete"
                                       ...
                                       onclick="return confirm('Delete this donor staff?')">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
