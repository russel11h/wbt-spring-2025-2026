...
<title>Staff Dashboard &mdash; Blood Donation Management</title>
...
<main class="main-content">
    <div class="page-header">
        <div>
            <h1 class="page-title">Manage Blood Stock</h1>
            <p class="page-sub">Add, edit, search and remove blood group stock records</p>
        </div>
    </div>
    ...
    <?php if (isset($_GET['msg'])): ?>
        <?php 
            $messages = [
                'added' => 'Blood stock record added successfully.',
                'updated' => 'Blood stock record updated successfully.',
                'deleted' => 'Blood stock record deleted successfully.'
            ];
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit Blood Stock (#' . intval($editing['id']) . ')' : '+ Add New Blood Stock' ?>
        </h3>
            ...
            <div class="field-row">
                <div class="field">
                    ...
                    <input type="text" id="title" name="title"
                           ...
                           placeholder="e.g. A+, B+, O-, AB+" required>
                </div>

                <div class="field">
                    <label for="author">Donor / Hospital Name</label>
                    <input type="text" id="author" name="author"
                           value="<?= htmlspecialchars($editing['author'] ?? '') ?>"
                           placeholder="Donor or hospital name" required>
                </div>
            </div>

            <div class="field-row">
                <div class="field">
                    <label for="quantity">Available Units</label>
        ...
        <div class="card-toolbar">
            <div class="search-wrap">
                ...
                <input type="text" id="searchInput" class="search-input"
                       placeholder="Search by blood group or donor/hospital name...">
            </div>
        ...
        <div class="table-wrap">
            <table class="data-table">
                ...
                <tbody id="tableBody">
                    <?php if (empty($books)): ?>
                        <tr>
                            <td colspan="6" class="empty">No blood stock records yet.</td>
                        </tr>
                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn-sm btn-delete"
                                       ...
                                       onclick="return confirm('Delete this blood stock record?')">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
...
<footer class="footer">&copy; <?= date('Y') ?> Blood Donation Management System</footer>
